				...
				<table class="table table-bordered border-primary">
					...
					<tbody>
						...
						<tr>
							...
							<?php endforeach; ?>
							<td><a class="btn btn-link" onclick="createModal('edit', <?php echo $exam['exam_id']; ?>)"><?php echo $exam['exam_id']; ?>編集する</a></td>
							<td><a class="btn btn-link" onclick="createModal('delete', <?php echo $exam['exam_id']; ?>)"><?php echo $exam['exam_id']; ?>削除する</a></td>
						</tr>
						<?php endwhile; ?>
					</tbody>
				</table>
